    ...
    <div class="ms-3">
        ...
        <div class="col-6 mb-4">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" v-model="category_name" name="name"
                    ...
                    <template v-for="category in categories">
                        <tr :class=" isId(category.id) ? 'd-none' : ''">
                            ...
                            <td>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="categoryDeleteModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" @click.prevent="deleteCategory(category.id)"
                                                        class="btn btn-danger" data-bs-dismiss="modal">Да удалить
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <tr :class=" isId(category.id) ? '' : 'd-none'">
                            ...
                            <td>
                                <button type="submit" @click.prevent="update(category.id)" class="btn btn-success-danger">
                                    Сохранить
                                </button>
                            </td>
                            <td>
